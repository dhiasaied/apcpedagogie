          ...
          <div data-aos="fade-up" data-aos-delay="600">
            ...
            if (isset($_GET['id'])) {
              ...
              if ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                // Affichez les détails de la vidéo dans un formulaire pour la confirmation de la suppression
                ?>
                ...
                <table class="table table-striped table-bordered">
                  ...
                  <tbody>
                    <tr>
                      <td><?php echo $row['Titre_Video']; ?></td>
                      <td><?php echo $row['Description_Video']; ?></td>
                      <td><?php echo $row['URL_Video']; ?></td>
                    </tr>
                  </tbody>
                </table>
                <form action="delete_confirm_videos.php" method="POST">
