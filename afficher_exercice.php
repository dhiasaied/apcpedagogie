    ...
    <div class="row">
        <div class="col-12 d-flex flex-column justify-content-center">
            <div class="card-fluid">
                <div class="card-body">
                    <h1 data-aos="fade-up" class="mb-4 display-4 fw-bold text-center text-primary">Liste des Exercices
                    </h1>
                    <div data-aos="fade-up" data-aos-delay="600">
                        <?php
                        require_once('connexion/connexion.php');

                        function getExercice($pdo, $id)
                        {
                        ...
                        ?>
                                <table class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td><?php echo $exercice['Id_Exercice']; ?></td>
                                            <td><?php echo $exercice['Id_Cours']; ?></td>
                                            <td><?php echo $exercice['Titre_Exercice']; ?></td>
                                            <td><?php echo $exercice['Description_Exercice']; ?></td>
                                            <td><?php echo $exercice['Solution_Exercice']; ?></td>
                                        </tr>
                                    </tbody>
                                </table>
                                <!-- Bouton de retour -->
                                <a href="exercices.php" class="btn btn-secondary">Retour</a>
                            <?php
                            } else {
