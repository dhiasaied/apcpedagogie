            ...
            <div class="card-fluid">
                <div class="card-body">
                    ...
                    <div data-aos="fade-up" data-aos-delay="600">
                        ...
                        // Check if the Tutorial ID is passed in the GET parameter
                        if (isset($_GET['id'])) {
                            $id = $_GET['id'];

                            // Prepare SQL query to retrieve Tutorial details
                            ...
                            if ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                                // Display the Tutorial details in a form for editing
                                ?>
                                <form action="update_tutoriels.php" method="POST">
                                    <table class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td><input type="text" name="titre" value="<?php echo $row['Titre_Tutoriel']; ?>"></td>
                                                <td><textarea name="description"><?php echo $row['Description_Tutoriel']; ?></textarea></td>
                                                <td><textarea name="contenu"><?php echo $row['Contenu_Tutoriel']; ?></textarea></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                    <input type="hidden" name="id_tutoriel" value="<?php echo $row['Id_Tutoriel']; ?>">
