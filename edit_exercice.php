            ...
            <div class="card-fluid">
                <div class="card-body">
                    ...
                    <div data-aos="fade-up" data-aos-delay="600">
                        ...
                        // Check if the exercise ID is passed in the GET parameter
                        if (isset($_GET['id'])) {
                            $id = $_GET['id'];

                            // Prepare SQL query to retrieve exercise details
                            ...
                            if ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                                // Display the exercise details in a form for editing
                                ?>
                                <form action="update_exercices.php" method="POST">
                                    <table class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td><input type="text" name="titre" value="<?php echo $row['Titre_Exercice']; ?>"></td>
                                                <td><textarea name="description"><?php echo $row['Description_Exercice']; ?></textarea></td>
                                                <td><textarea name="solution"><?php echo $row['Solution_Exercice']; ?></textarea></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                    <input type="hidden" name="id_exercice" value="<?php echo $row['Id_Exercice']; ?>">
