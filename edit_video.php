            ...
            <div class="card-fluid">
                <div class="card-body">
                    ...
                    <div data-aos="fade-up" data-aos-delay="600">
                        ...
                        // Check if the Video ID is passed in the GET parameter
                        if (isset($_GET['id'])) {
                            $id = $_GET['id'];

                            // Prepare SQL query to retrieve Video details
                            ...
                            if ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                                // Display the Video details in a form for editing
                                ?>
                                <form action="update_videos.php" method="POST">
                                    <table class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td><input type="text" name="titre" value="<?php echo $row['Titre_Video']; ?>"></td>
                                                <td><textarea name="description"><?php echo $row['Description_Video']; ?></textarea></td>
                                                <td><input type="text" name="url" value="<?php echo $row['URL_Video']; ?>"></td>
                                            </tr>
                                        </tbody>
                                    </table>
