    ...
    <div class="row">
        <div class="col-12 d-flex flex-column justify-content-center">
            <div class="card-fluid">
                <div class="card-body">
                    <h1 data-aos="fade-up" class="mb-4 display-4 fw-bold text-center text-primary">Liste des Videos
                    </h1>
                                ...
                                <table class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><?php echo $video['Id_Cours']; ?></td>
                                            <td><?php echo $video['Titre_Video']; ?></td>
                                            <td><?php echo $video['Description_Video']; ?></td>
                                            <td><?php echo $video['URL_Video']; ?></td>
                                        </tr>
                                    </tbody>
                                </table>
                                <!-- Bouton de retour -->
                                <a href="videos.php" class="btn btn-secondary">Retour</a>
                            <?php
                            } else {
