    ...
    <div class="row">
        <div class="col-12 d-flex flex-column justify-content-center">
            <div class="card-fluid">
                <div class="card-body">
                    <h1 data-aos="fade-up" class="mb-4 display-4 fw-bold text-center text-primary">Liste des Tutoriels
                    </h1>
                    <div data-aos="fade-up" data-aos-delay="600">
                        <?php
                        require_once('connexion/connexion.php');

                        function getTutoriel($pdo, $id)
                        {
                        ...
                        ?>
                                <table class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td><?php echo $tutoriel['Id_Tutoriel']; ?></td>
                                            <td><?php echo $tutoriel['Id_Cours']; ?></td>
                                            <td><?php echo $tutoriel['Titre_Tutoriel']; ?></td>
                                            <td><?php echo $tutoriel['Description_Tutoriel']; ?></td>
                                            <td><?php echo $tutoriel['Contenu_Tutoriel']; ?></td>
                                        </tr>
                                    </tbody>
                                </table>
                                <!-- Bouton de retour -->
                                <a href="tutoriels.php" class="btn btn-secondary">Retour</a>
                            <?php
                            } else {
